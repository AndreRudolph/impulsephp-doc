...
All required changes for a full authentication example can be generated by executing the command below. Please note that no further changes that are explained within this tutorial are needed.
